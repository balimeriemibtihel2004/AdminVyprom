        ...
        <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    <li><router-link to="/" key="t-products">Products</router-link></li>
                    <li><router-link to="/productDetails">Product Detail</router-link></li>
                    ...
                    <li><router-link to="/addProduct" key="t-add-product">Add Product</router-link></li>
                </ul>
            </li>
